 ...
 * under the License.
 */
import { SupersetPluginChartHorizontalComposedCustom } from '../src';
 ...
 */
describe('superset-plugin-chart-horizontal-composed-custom', () => {
  it('exists', () => {
    expect(SupersetPluginChartHorizontalComposedCustom).toBeDefined();
  });
});
