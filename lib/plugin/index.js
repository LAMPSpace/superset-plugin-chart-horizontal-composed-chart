...
class SupersetPluginChartHorizontalComposedCustom extends _core.ChartPlugin {
  /**
  ...
  constructor() {
    var metadata = new _core.ChartMetadata({
      description: 'Superset Plugin Chart Horizontal Composed Custom',
      name: (0, _core.t)('Horizontal Composed Custom'),
      thumbnail: _thumbnail.default
    });
    super({
      buildQuery: _buildQuery.default,
      controlPanel: _controlPanel.default,
      loadChart: () => Promise.resolve().then(() => _interopRequireWildcard(require('../SupersetPluginChartHorizontalComposedCustom'))),
      metadata,
...
exports.default = SupersetPluginChartHorizontalComposedCustom;